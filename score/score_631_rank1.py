...
if __name__ == '__main__':
    ...
    rects3 = ax1.barh([7], [reserve1[7]], width, color='red', edgecolor='black')
    ax1.set_yticks(x)
    ...
    for a, b in zip(x, reserve1):
        ax1.text(31670, a - 0.3, '%.1f' % b, ha='center', va='bottom', fontsize=font_size)
    ...
    strong = ax2.barh([6], [burst[6]], width, color='red', edgecolor='black')
    ax2.set_yticks(x)
    ...
    rects1 = ax3.barh([7], [best[7]], width, color='red', edgecolor='black')
    ax3.set_yticks(x)
    ...
    for a, b in zip(x, best):
        ax3.text(b+80 if b < 500 else b-80, a-0.3, '%.1f' % b, ha='center', va='bottom',
                 fontsize=font_size)
