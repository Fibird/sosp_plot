...
client_labels = ['B: r=3000,l=5000', 'R: r=1200,l=1500', 'BE: r=0,l=500']
...
def io_plot(plot_data, save_img=False):
    ...
    plt.legend(ncol=2, loc='upper center', prop=font1)
    ...
    if save_img:
        ...
        plt.savefig("rl2_631_long_iops.svg")
    plt.show()


if __name__ == '__main__':
    data = get_data_from_sim("rl2_631_long_iops.log")
    io_plot(data, True)
